...
const degradadoPurple = 'linear-gradient(90deg, rgba(150,101,253,0.6) 0%, rgba(150,101,253,1) 50%, rgba(150,101,253,0.6) 100%)'
...
const btnDesk = {
    textDecoration: 'none', background: degradadoPurple, color: '#fff', borderRadius: '3px',
