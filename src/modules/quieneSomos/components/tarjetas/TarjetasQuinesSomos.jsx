...
// Css variable
// const chunkStyle = { height: '8em', borderRadius: '5px', opacity: 0.8, margin: '0em 1.5em',
...
export const TarjetasQuinesSomos = () => {
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
      ...
      scrollPosition < 0.10 && console.log('Cerrar Inicio')
      scrollPosition > 0.15 && console.log('tarjeta 1')
      scrollPosition > 0.26 && console.log('tarjeta 2')
      scrollPosition > 0.37 && console.log('tarjeta 3')
      scrollPosition > 0.50 && console.log('Cerrar fin')
  })
  ...
  return (
    <div style={{
      ...
      {/* <TarjetaContenedor option="0">
        <img src={logoDmnt} alt="logoDmnt" style={{ width: '10em',height:'4em', position:'absolute', 
      ...
      <TarjetaContenedor option="2">
        <div style={{width:'100%', height:'100%', display:'flex', justifyContent:'center', alignItems:'end', position:'absolute', top:0}}>
          ...
          <motion.img animate={{ rotate: 360 }}
            ...
            src={world} alt="world" style={{ width:  window.screen.width > 900 ? '50vw' : '200vw', margin: 'auto', 
