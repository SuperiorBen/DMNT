...
export const TarjetasQuinesSomos = () => {
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    ...
    scrollPosition < 0.10 && setSection(0)
    scrollPosition > 0.15 && setSection(1)
    scrollPosition > 0.26 && setSection(2)
    scrollPosition > 0.37 && setSection(3)
    scrollPosition > 0.50 && setSection(0)
  })
  ...
  return (
    <div style={{
      ...
      {
        section == 1 && <TarjetaContenedor option="0">
      ...
      {
        section == 2 && <TarjetaContenedor option="1">
      ...
      {
        section == 3 && <TarjetaContenedor option="2">
